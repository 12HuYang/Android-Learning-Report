...
> 代码在这里: [https://github.com/didikee/Android-Learning-Report](https://github.com/didikee/Android-Learning-Report)

#### 附言

> 有的小伙伴肯定嫌麻烦,谁会点开那么慢的Github,更不会注册账户`Star`或者`Fork`的,如果遇到你可以这样解决"丢一秒"的问题.
